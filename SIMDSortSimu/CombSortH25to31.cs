...
namespace SIMDSortSimu {
    public static class CombSortH25to31 {

        public static int Iter(float[] vs, uint h) {
            if (h <= MM256.AVX2_FLOAT_STRIDE * 3 || h >= MM256.AVX2_FLOAT_STRIDE * 4) {
            ...
            if (e > 0) {
                ...
                a3 = MM256.MaskLoad(vs, MM256.AVX2_FLOAT_STRIDE * 3, h - MM256.AVX2_FLOAT_STRIDE * 3);
                ...
                for (; i < e; i += h) {
                    ...
                    b3 = MM256.MaskLoad(vs, i + h + MM256.AVX2_FLOAT_STRIDE * 3, h - MM256.AVX2_FLOAT_STRIDE * 3);
                    ...
                    MM256.MaskStore(vs, i + MM256.AVX2_FLOAT_STRIDE * 3, h - MM256.AVX2_FLOAT_STRIDE * 3, x3);
                    a0 = y0;
                    a1 = y1;
                    a2 = y2;
                    a3 = y3;
                ...
                MM256.MaskStore(vs, i + MM256.AVX2_FLOAT_STRIDE * 3, h - MM256.AVX2_FLOAT_STRIDE * 3, a3);
            }

            {
                ...
                a3 = MM256.MaskLoad(vs, e + MM256.AVX2_FLOAT_STRIDE * 3, h - MM256.AVX2_FLOAT_STRIDE * 3);
                b0 = MM256.Load(vs, e + h);
                b1 = MM256.Load(vs, e + h + MM256.AVX2_FLOAT_STRIDE);
                b2 = MM256.Load(vs, e + h + MM256.AVX2_FLOAT_STRIDE * 2);
                b3 = MM256.MaskLoad(vs, e + h + MM256.AVX2_FLOAT_STRIDE * 3, h - MM256.AVX2_FLOAT_STRIDE * 3);
                ...
                MM256.MaskStore(vs, e + MM256.AVX2_FLOAT_STRIDE * 3, h - MM256.AVX2_FLOAT_STRIDE * 3, x3);
                MM256.Store(vs, e + h, y0);
                MM256.Store(vs, e + h + MM256.AVX2_FLOAT_STRIDE, y1);
                MM256.Store(vs, e + h + MM256.AVX2_FLOAT_STRIDE * 2, y2);
                MM256.MaskStore(vs, e + h + MM256.AVX2_FLOAT_STRIDE * 3, h - MM256.AVX2_FLOAT_STRIDE * 3, y3);
