...
__forceinline static __m256 _mm256_needsswap_ps(__m256 x, __m256 y) {
    return _mm256_cmplt_ignnan_ps(x, y);
}
...
int sortwithkeydsc_ignnan_s2_s(const uint n, const uint s, uint* __restrict v_ptr, float* __restrict k_ptr) {
    if (s != 2) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeydsc_ignnan_s3_s(const uint n, const uint s, uint* __restrict v_ptr, float* __restrict k_ptr) {
    if (s != 3) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeydsc_ignnan_s4_s(const uint n, const uint s, uint* __restrict v_ptr, float* __restrict k_ptr) {
    if (s != 4) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeydsc_ignnan_s5_s(const uint n, const uint s, uint* __restrict v_ptr, float* __restrict k_ptr) {
    if (s != 5) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeydsc_ignnan_s6_s(const uint n, const uint s, uint* __restrict v_ptr, float* __restrict k_ptr) {
    if (s != 6) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeydsc_ignnan_s7_s(const uint n, const uint s, uint* __restrict v_ptr, float* __restrict k_ptr) {
    if (s != 7) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeydsc_ignnan_s8_s(const uint n, const uint s, uint* __restrict v_ptr, float* __restrict k_ptr) {
    if (s != 8) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeydsc_ignnan_s9_s(const uint n, const uint s, uint* __restrict v_ptr, float* __restrict k_ptr) {
    if (s != 9) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeydsc_ignnan_s10_s(const uint n, const uint s, uint* __restrict v_ptr, float* __restrict k_ptr) {
    if (s != 10) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeydsc_ignnan_s11_s(const uint n, const uint s, uint* __restrict v_ptr, float* __restrict k_ptr) {
    if (s != 11) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeydsc_ignnan_s12_s(const uint n, const uint s, uint* __restrict v_ptr, float* __restrict k_ptr) {
    if (s != 12) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeydsc_ignnan_s13_s(const uint n, const uint s, uint* __restrict v_ptr, float* __restrict k_ptr) {
    if (s != 13) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeydsc_ignnan_s14_s(const uint n, const uint s, uint* __restrict v_ptr, float* __restrict k_ptr) {
    if (s != 14) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeydsc_ignnan_s15_s(const uint n, const uint s, uint* __restrict v_ptr, float* __restrict k_ptr) {
    if (s != 15) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeydsc_ignnan_s16_s(const uint n, const uint s, uint* __restrict v_ptr, float* __restrict k_ptr) {
...
int sortwithkeydsc_ignnan_s17to31_s(const uint n, const uint s, uint* __restrict v_ptr, float* __restrict k_ptr) {
...
int sortwithkeydsc_ignnan_s32to63_s(const uint n, const uint s, uint* __restrict v_ptr, float* __restrict k_ptr) {
...
int sortwithkeydsc_ignnan_s64plus_s(const uint n, const uint s, uint* __restrict v_ptr, float* __restrict k_ptr) {
...
int sortwithkeydsc_ignnan_s(const uint n, const uint s, uint* __restrict v_ptr, float* __restrict k_ptr) {
    if (s <= 1) {
        return SUCCESS;
    }
    else if (s <= 2) {
        return sortwithkeydsc_ignnan_s2_s(n, s, v_ptr, k_ptr);
    }
    else if (s <= 3) {
        return sortwithkeydsc_ignnan_s3_s(n, s, v_ptr, k_ptr);
    }
    else if (s <= 4) {
        return sortwithkeydsc_ignnan_s4_s(n, s, v_ptr, k_ptr);
    }
    else if (s <= 5) {
        return sortwithkeydsc_ignnan_s5_s(n, s, v_ptr, k_ptr);
    }
    else if (s <= 6) {
        return sortwithkeydsc_ignnan_s6_s(n, s, v_ptr, k_ptr);
    }
    else if (s <= 7) {
        return sortwithkeydsc_ignnan_s7_s(n, s, v_ptr, k_ptr);
    }
    else if (s <= 8) {
        return sortwithkeydsc_ignnan_s8_s(n, s, v_ptr, k_ptr);
    }
    else if (s <= 9) {
        return sortwithkeydsc_ignnan_s9_s(n, s, v_ptr, k_ptr);
    }
    else if (s <= 10) {
        return sortwithkeydsc_ignnan_s10_s(n, s, v_ptr, k_ptr);
    }
    else if (s <= 11) {
        return sortwithkeydsc_ignnan_s11_s(n, s, v_ptr, k_ptr);
    }
    else if (s <= 12) {
        return sortwithkeydsc_ignnan_s12_s(n, s, v_ptr, k_ptr);
    }
    else if (s <= 13) {
        return sortwithkeydsc_ignnan_s13_s(n, s, v_ptr, k_ptr);
    }
    else if (s <= 14) {
        return sortwithkeydsc_ignnan_s14_s(n, s, v_ptr, k_ptr);
    }
    else if (s <= 15) {
        return sortwithkeydsc_ignnan_s15_s(n, s, v_ptr, k_ptr);
    }
    else if (s <= 16) {
        return sortwithkeydsc_ignnan_s16_s(n, s, v_ptr, k_ptr);
    }
    else if (s < 32) {
        return sortwithkeydsc_ignnan_s17to31_s(n, s, v_ptr, k_ptr);
    }
    else if (s < 64) {
        return sortwithkeydsc_ignnan_s32to63_s(n, s, v_ptr, k_ptr);
    }
    else {
        return sortwithkeydsc_ignnan_s64plus_s(n, s, v_ptr, k_ptr);
    }
}
