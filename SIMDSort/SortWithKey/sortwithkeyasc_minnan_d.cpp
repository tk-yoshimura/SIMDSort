...
__forceinline static __m256d _mm256_needsswap_pd(__m256d x, __m256d y) {
    return _mm256_cmpgt_minnan_pd(x, y);
}
...
int sortwithkeyasc_minnan_s2_d(const uint n, const uint s, ulong* __restrict v_ptr, double* __restrict k_ptr) {
    if (s != 2) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeyasc_minnan_s3_d(const uint n, const uint s, ulong* __restrict v_ptr, double* __restrict k_ptr) {
    if (s != 3) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeyasc_minnan_s4_d(const uint n, const uint s, ulong* __restrict v_ptr, double* __restrict k_ptr) {
    if (s != 4) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeyasc_minnan_s5_d(const uint n, const uint s, ulong* __restrict v_ptr, double* __restrict k_ptr) {
    if (s != 5) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeyasc_minnan_s6_d(const uint n, const uint s, ulong* __restrict v_ptr, double* __restrict k_ptr) {
    if (s != 6) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeyasc_minnan_s7_d(const uint n, const uint s, ulong* __restrict v_ptr, double* __restrict k_ptr) {
    if (s != 7) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeyasc_minnan_s8_d(const uint n, const uint s, ulong* __restrict v_ptr, double* __restrict k_ptr) {
...
int sortwithkeyasc_minnan_s9_d(const uint n, const uint s, ulong* __restrict v_ptr, double* __restrict k_ptr) {
    if (s != 9) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeyasc_minnan_s10_d(const uint n, const uint s, ulong* __restrict v_ptr, double* __restrict k_ptr) {
    if (s != 10) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeyasc_minnan_s11_d(const uint n, const uint s, ulong* __restrict v_ptr, double* __restrict k_ptr) {
    if (s != 11) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeyasc_minnan_s12_d(const uint n, const uint s, ulong* __restrict v_ptr, double* __restrict k_ptr) {
    if (s != 12) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeyasc_minnan_s13_d(const uint n, const uint s, ulong* __restrict v_ptr, double* __restrict k_ptr) {
    if (s != 13) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeyasc_minnan_s14_d(const uint n, const uint s, ulong* __restrict v_ptr, double* __restrict k_ptr) {
    if (s != 14) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeyasc_minnan_s15_d(const uint n, const uint s, ulong* __restrict v_ptr, double* __restrict k_ptr) {
    if (s != 15) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeyasc_minnan_s16_d(const uint n, const uint s, ulong* __restrict v_ptr, double* __restrict k_ptr) {
    if (s != 16) {
        return FAILURE_BADPARAM;
    }
...
int sortwithkeyasc_minnan_s17to31_d(const uint n, const uint s, ulong* __restrict v_ptr, double* __restrict k_ptr) {
...
int sortwithkeyasc_minnan_s32plus_d(const uint n, const uint s, ulong* __restrict v_ptr, double* __restrict k_ptr) {
...
int sortwithkeyasc_minnan_d(const uint n, const uint s, ulong* __restrict v_ptr, double* __restrict k_ptr) {
    if (s <= 1) {
        return SUCCESS;
    }
    else if (s <= 2) {
        return sortwithkeyasc_minnan_s2_d(n, s, v_ptr, k_ptr);
    }
    else if (s <= 3) {
        return sortwithkeyasc_minnan_s3_d(n, s, v_ptr, k_ptr);
    }
    else if (s <= 4) {
        return sortwithkeyasc_minnan_s4_d(n, s, v_ptr, k_ptr);
    }
    else if (s <= 5) {
        return sortwithkeyasc_minnan_s5_d(n, s, v_ptr, k_ptr);
    }
    else if (s <= 6) {
        return sortwithkeyasc_minnan_s6_d(n, s, v_ptr, k_ptr);
    }
    else if (s <= 7) {
        return sortwithkeyasc_minnan_s7_d(n, s, v_ptr, k_ptr);
    }
    else if (s <= 8) {
        return sortwithkeyasc_minnan_s8_d(n, s, v_ptr, k_ptr);
    }
    else if (s <= 9) {
        return sortwithkeyasc_minnan_s9_d(n, s, v_ptr, k_ptr);
    }
    else if (s <= 10) {
        return sortwithkeyasc_minnan_s10_d(n, s, v_ptr, k_ptr);
    }
    else if (s <= 11) {
        return sortwithkeyasc_minnan_s11_d(n, s, v_ptr, k_ptr);
    }
    else if (s <= 12) {
        return sortwithkeyasc_minnan_s12_d(n, s, v_ptr, k_ptr);
    }
    else if (s <= 13) {
        return sortwithkeyasc_minnan_s13_d(n, s, v_ptr, k_ptr);
    }
    else if (s <= 14) {
        return sortwithkeyasc_minnan_s14_d(n, s, v_ptr, k_ptr);
    }
    else if (s <= 15) {
        return sortwithkeyasc_minnan_s15_d(n, s, v_ptr, k_ptr);
    }
    else if (s <= 16) {
        return sortwithkeyasc_minnan_s16_d(n, s, v_ptr, k_ptr);
    }
    else if (s < 32) {
        return sortwithkeyasc_minnan_s17to31_d(n, s, v_ptr, k_ptr);
    }
    else {
        return sortwithkeyasc_minnan_s32plus_d(n, s, v_ptr, k_ptr);
    }
}
