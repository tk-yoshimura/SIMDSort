...
int sortdsc_minnan_s2_d(const uint n, const uint s, double* v_ptr) {
    if (s != 2) {
        return FAILURE_BADPARAM;
    }
...
int sortdsc_minnan_s3_d(const uint n, const uint s, double* v_ptr) {
    if (s != 3) {
        return FAILURE_BADPARAM;
    }
...
int sortdsc_minnan_s4_d(const uint n, const uint s, double* v_ptr) {
    if (s != 4) {
        return FAILURE_BADPARAM;
    }
...
int sortdsc_minnan_s5_d(const uint n, const uint s, double* v_ptr) {
    if (s != 5) {
        return FAILURE_BADPARAM;
    }
...
int sortdsc_minnan_s6_d(const uint n, const uint s, double* v_ptr) {
    if (s != 6) {
        return FAILURE_BADPARAM;
    }
...
int sortdsc_minnan_s7_d(const uint n, const uint s, double* v_ptr) {
    if (s != 7) {
        return FAILURE_BADPARAM;
    }
...
int sortdsc_minnan_s8_d(const uint n, const uint s, double* v_ptr) {
...
int sortdsc_minnan_s9_d(const uint n, const uint s, double* v_ptr) {
    if (s != 9) {
        return FAILURE_BADPARAM;
    }
...
int sortdsc_minnan_s10_d(const uint n, const uint s, double* v_ptr) {
    if (s != 10) {
        return FAILURE_BADPARAM;
    }
...
int sortdsc_minnan_s11_d(const uint n, const uint s, double* v_ptr) {
    if (s != 11) {
        return FAILURE_BADPARAM;
    }
...
int sortdsc_minnan_s12_d(const uint n, const uint s, double* v_ptr) {
    if (s != 12) {
        return FAILURE_BADPARAM;
    }
...
int sortdsc_minnan_s13_d(const uint n, const uint s, double* v_ptr) {
    if (s != 13) {
        return FAILURE_BADPARAM;
    }
...
int sortdsc_minnan_s14_d(const uint n, const uint s, double* v_ptr) {
    if (s != 14) {
        return FAILURE_BADPARAM;
    }
...
int sortdsc_minnan_s15_d(const uint n, const uint s, double* v_ptr) {
    if (s != 15) {
        return FAILURE_BADPARAM;
    }
...
int sortdsc_minnan_s16_d(const uint n, const uint s, double* v_ptr) {
    if (s != 16) {
        return FAILURE_BADPARAM;
    }
...
int sortdsc_minnan_s17to31_d(const uint n, const uint s, double* v_ptr) {
...
int sortdsc_minnan_s32plus_d(const uint n, const uint s, double* v_ptr) {
