...
int sortasc_maxnan_s2_d(const uint n, const uint s, double* v_ptr) {
    if (s != 2) {
        return FAILURE_BADPARAM;
    }
    ...
    if (((size_t)v_ptr % AVX2_ALIGNMENT) != 0) {
        while (r >= AVX2_DOUBLE_STRIDE * 4 / 2) {
            ...
            _mm256_storeu_x4_pd(v_ptr, y0, y1, y2, y3);

            v_ptr += AVX2_DOUBLE_STRIDE * 4;
            r -= AVX2_DOUBLE_STRIDE * 4 / 2;
        }
        if (r >= AVX2_DOUBLE_STRIDE) {
            _mm256_loadu_x2_pd(v_ptr, x0, x1);

            y0 = _mm256_sort2x2_pd(x0);
            y1 = _mm256_sort2x2_pd(x1);

            _mm256_storeu_x2_pd(v_ptr, y0, y1);

            v_ptr += AVX2_DOUBLE_STRIDE * 2;
            r -= AVX2_DOUBLE_STRIDE;
        }
        if (r >= AVX2_DOUBLE_STRIDE / 2) {
            _mm256_loadu_x1_pd(v_ptr, x0);

            y0 = _mm256_sort2x2_pd(x0);

            _mm256_storeu_x1_pd(v_ptr, y0);
...
int sortasc_maxnan_s3_d(const uint n, const uint s, double* v_ptr) {
    if (s != 3) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s4_d(const uint n, const uint s, double* v_ptr) {
    if (s != 4) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s5_d(const uint n, const uint s, double* v_ptr) {
    if (s != 5) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s6_d(const uint n, const uint s, double* v_ptr) {
    if (s != 6) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s7_d(const uint n, const uint s, double* v_ptr) {
    if (s != 7) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s8_d(const uint n, const uint s, double* v_ptr) {
...
int sortasc_maxnan_s9_d(const uint n, const uint s, double* v_ptr) {
    if (s != 9) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s10_d(const uint n, const uint s, double* v_ptr) {
    if (s != 10) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s11_d(const uint n, const uint s, double* v_ptr) {
    if (s != 11) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s12_d(const uint n, const uint s, double* v_ptr) {
    if (s != 12) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s13_d(const uint n, const uint s, double* v_ptr) {
    if (s != 13) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s14_d(const uint n, const uint s, double* v_ptr) {
    if (s != 14) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s15_d(const uint n, const uint s, double* v_ptr) {
    if (s != 15) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s16_d(const uint n, const uint s, double* v_ptr) {
    if (s != 16) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s17to31_d(const uint n, const uint s, double* v_ptr) {
...
int sortasc_maxnan_s32plus_d(const uint n, const uint s, double* v_ptr) {
...
int sortasc_maxnan_d(const uint n, const uint s, double* v_ptr) {
    if (s <= 1) {
        return SUCCESS;
    }
    else if (s <= 2) {
        return sortasc_maxnan_s2_d(n, s, v_ptr);
    }
    else if (s <= 3) {
        return sortasc_maxnan_s3_d(n, s, v_ptr);
    }
    else if (s <= 4) {
        return sortasc_maxnan_s4_d(n, s, v_ptr);
    }
    else if (s <= 5) {
        return sortasc_maxnan_s5_d(n, s, v_ptr);
    }
    else if (s <= 6) {
        return sortasc_maxnan_s6_d(n, s, v_ptr);
    }
    else if (s <= 7) {
        return sortasc_maxnan_s7_d(n, s, v_ptr);
    }
    else if (s <= 8) {
        return sortasc_maxnan_s8_d(n, s, v_ptr);
    }
    else if (s <= 9) {
        return sortasc_maxnan_s9_d(n, s, v_ptr);
    }
    else if (s <= 10) {
        return sortasc_maxnan_s10_d(n, s, v_ptr);
    }
    else if (s <= 11) {
        return sortasc_maxnan_s11_d(n, s, v_ptr);
    }
    else if (s <= 12) {
        return sortasc_maxnan_s12_d(n, s, v_ptr);
    }
    else if (s <= 13) {
        return sortasc_maxnan_s13_d(n, s, v_ptr);
    }
    else if (s <= 14) {
        return sortasc_maxnan_s14_d(n, s, v_ptr);
    }
    else if (s <= 15) {
        return sortasc_maxnan_s15_d(n, s, v_ptr);
    }
    else if (s <= 16) {
        return sortasc_maxnan_s16_d(n, s, v_ptr);
    }
    else if (s < 32) {
        return sortasc_maxnan_s17to31_d(n, s, v_ptr);
    }
    else {
        return sortasc_maxnan_s32plus_d(n, s, v_ptr);
    }
}
