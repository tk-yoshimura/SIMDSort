...
int sortdsc_ignnan_s16_s(const uint n, const uint s, float* v_ptr) {
...
int sortdsc_ignnan_s64plus_s(const uint n, const uint s, float* v_ptr) {
...
int sortdsc_ignnan_s(const uint n, const uint s, float* v_ptr) {
    if (s <= 1) {
        return SUCCESS;
    }
    else if (s <= 2) {
