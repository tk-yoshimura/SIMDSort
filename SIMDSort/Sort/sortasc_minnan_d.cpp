...
int sortasc_minnan_s2_d(const uint n, const uint s, double* v_ptr) {
    if (s != 2) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_minnan_s3_d(const uint n, const uint s, double* v_ptr) {
    if (s != 3) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_minnan_s4_d(const uint n, const uint s, double* v_ptr) {
    if (s != 4) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_minnan_s5_d(const uint n, const uint s, double* v_ptr) {
    if (s != 5) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_minnan_s6_d(const uint n, const uint s, double* v_ptr) {
    if (s != 6) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_minnan_s7_d(const uint n, const uint s, double* v_ptr) {
    if (s != 7) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_minnan_s8_d(const uint n, const uint s, double* v_ptr) {
...
int sortasc_minnan_s9_d(const uint n, const uint s, double* v_ptr) {
    if (s != 9) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_minnan_s10_d(const uint n, const uint s, double* v_ptr) {
    if (s != 10) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_minnan_s11_d(const uint n, const uint s, double* v_ptr) {
    if (s != 11) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_minnan_s12_d(const uint n, const uint s, double* v_ptr) {
    if (s != 12) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_minnan_s13_d(const uint n, const uint s, double* v_ptr) {
    if (s != 13) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_minnan_s14_d(const uint n, const uint s, double* v_ptr) {
    if (s != 14) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_minnan_s15_d(const uint n, const uint s, double* v_ptr) {
    if (s != 15) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_minnan_s16_d(const uint n, const uint s, double* v_ptr) {
    if (s != 16) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_minnan_s17to31_d(const uint n, const uint s, double* v_ptr) {
...
int sortasc_minnan_s32plus_d(const uint n, const uint s, double* v_ptr) {
...
int sortasc_minnan_d(const uint n, const uint s, double* v_ptr) {
    if (s <= 1) {
        return SUCCESS;
    }
    else if (s <= 2) {
        return sortasc_minnan_s2_d(n, s, v_ptr);
    }
    else if (s <= 3) {
        return sortasc_minnan_s3_d(n, s, v_ptr);
    }
    else if (s <= 4) {
        return sortasc_minnan_s4_d(n, s, v_ptr);
    }
    else if (s <= 5) {
        return sortasc_minnan_s5_d(n, s, v_ptr);
    }
    else if (s <= 6) {
        return sortasc_minnan_s6_d(n, s, v_ptr);
    }
    else if (s <= 7) {
        return sortasc_minnan_s7_d(n, s, v_ptr);
    }
    else if (s <= 8) {
        return sortasc_minnan_s8_d(n, s, v_ptr);
    }
    else if (s <= 9) {
        return sortasc_minnan_s9_d(n, s, v_ptr);
    }
    else if (s <= 10) {
        return sortasc_minnan_s10_d(n, s, v_ptr);
    }
    else if (s <= 11) {
        return sortasc_minnan_s11_d(n, s, v_ptr);
    }
    else if (s <= 12) {
        return sortasc_minnan_s12_d(n, s, v_ptr);
    }
    else if (s <= 13) {
        return sortasc_minnan_s13_d(n, s, v_ptr);
    }
    else if (s <= 14) {
        return sortasc_minnan_s14_d(n, s, v_ptr);
    }
    else if (s <= 15) {
        return sortasc_minnan_s15_d(n, s, v_ptr);
    }
    else if (s <= 16) {
        return sortasc_minnan_s16_d(n, s, v_ptr);
    }
    else if (s < 32) {
        return sortasc_minnan_s17to31_d(n, s, v_ptr);
    }
    else {
        return sortasc_minnan_s32plus_d(n, s, v_ptr);
    }
}
