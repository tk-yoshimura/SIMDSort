...
__forceinline static __m256 _mm256_needsswap_ps(__m256 x, __m256 y) {
    return _mm256_cmpgt_maxnan_ps(x, y);
}
...
int sortasc_maxnan_s2_s(const uint n, const uint s, float* v_ptr) {
    if (s != 2) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s3_s(const uint n, const uint s, float* v_ptr) {
    if (s != 3) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s4_s(const uint n, const uint s, float* v_ptr) {
    if (s != 4) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s5_s(const uint n, const uint s, float* v_ptr) {
    if (s != 5) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s6_s(const uint n, const uint s, float* v_ptr) {
    if (s != 6) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s7_s(const uint n, const uint s, float* v_ptr) {
    if (s != 7) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s8_s(const uint n, const uint s, float* v_ptr) {
    if (s != 8) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s9_s(const uint n, const uint s, float* v_ptr) {
    if (s != 9) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s10_s(const uint n, const uint s, float* v_ptr) {
    if (s != 10) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s11_s(const uint n, const uint s, float* v_ptr) {
    if (s != 11) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s12_s(const uint n, const uint s, float* v_ptr) {
    if (s != 12) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s13_s(const uint n, const uint s, float* v_ptr) {
    if (s != 13) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s14_s(const uint n, const uint s, float* v_ptr) {
    if (s != 14) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s15_s(const uint n, const uint s, float* v_ptr) {
    if (s != 15) {
        return FAILURE_BADPARAM;
    }
...
int sortasc_maxnan_s16_s(const uint n, const uint s, float* v_ptr) {
...
int sortasc_maxnan_s17to31_s(const uint n, const uint s, float* v_ptr) {
...
int sortasc_maxnan_s32to63_s(const uint n, const uint s, float* v_ptr) {
...
int sortasc_maxnan_s64plus_s(const uint n, const uint s, float* v_ptr) {
...
int sortasc_maxnan_s(const uint n, const uint s, float* v_ptr) {
    if (s <= 1) {
        return SUCCESS;
    }
    else if (s <= 2) {
        return sortasc_maxnan_s2_s(n, s, v_ptr);
    }
    else if (s <= 3) {
        return sortasc_maxnan_s3_s(n, s, v_ptr);
    }
    else if (s <= 4) {
        return sortasc_maxnan_s4_s(n, s, v_ptr);
    }
    else if (s <= 5) {
        return sortasc_maxnan_s5_s(n, s, v_ptr);
    }
    else if (s <= 6) {
        return sortasc_maxnan_s6_s(n, s, v_ptr);
    }
    else if (s <= 7) {
        return sortasc_maxnan_s7_s(n, s, v_ptr);
    }
    else if (s <= 8) {
        return sortasc_maxnan_s8_s(n, s, v_ptr);
    }
    else if (s <= 9) {
        return sortasc_maxnan_s9_s(n, s, v_ptr);
    }
    else if (s <= 10) {
        return sortasc_maxnan_s10_s(n, s, v_ptr);
    }
    else if (s <= 11) {
        return sortasc_maxnan_s11_s(n, s, v_ptr);
    }
    else if (s <= 12) {
        return sortasc_maxnan_s12_s(n, s, v_ptr);
    }
    else if (s <= 13) {
        return sortasc_maxnan_s13_s(n, s, v_ptr);
    }
    else if (s <= 14) {
        return sortasc_maxnan_s14_s(n, s, v_ptr);
    }
    else if (s <= 15) {
        return sortasc_maxnan_s15_s(n, s, v_ptr);
    }
    else if (s <= 16) {
        return sortasc_maxnan_s16_s(n, s, v_ptr);
    }
    else if (s < 32) {
        return sortasc_maxnan_s17to31_s(n, s, v_ptr);
    }
    else if (s < 64) {
        return sortasc_maxnan_s32to63_s(n, s, v_ptr);
    }
    else {
        return sortasc_maxnan_s64plus_s(n, s, v_ptr);
    }
}
