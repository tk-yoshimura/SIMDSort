...
int cmpeq_test_s() {
    ...
    if (_mm256_movemask_ps(_mm256_cmpeq_ps(a, b)) != 0b00001000) {
        printf("err");
        return -1;
    }

    if (_mm256_movemask_ps(_mm256_cmpeq_ps(b, a)) != 0b00001000) {
        printf("err");
        return -1;
    }

    if (_mm256_movemask_ps(_mm256_cmpeq_ps(a, a)) != 0b11111111) {
        printf("err");
        return -1;
    }

    if (_mm256_movemask_ps(_mm256_cmpeq_ps(b, b)) != 0b11111111) {
        printf("err");
        return -1;
    }
